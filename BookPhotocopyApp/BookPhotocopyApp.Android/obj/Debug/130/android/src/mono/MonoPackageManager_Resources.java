...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "BookPhotocopyApp.Android.dll" comes first in this list. */
		"BookPhotocopyApp.Android.dll",
		"BookPhotocopyApp.dll",
		"FormsViewGroup.dll",
		"Plugin.Permissions.dll",
		"Tesseract.dll",
		"VIEApps.Components.Utility.Epub.dll",
